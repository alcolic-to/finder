...
TEST(suffix_trie_tests, sanity_test_1)
{
    ...
    s.insert_suffix("banana", "banana");

    ASSERT_TRUE(*s.search_suffix("banana")[0] == "banana");
    ASSERT_TRUE(*s.search_suffix("anana")[0] == "banana");
    ASSERT_TRUE(*s.search_suffix("nana")[0] == "banana");
    ASSERT_TRUE(*s.search_suffix("ana")[0] == "banana");
    ASSERT_TRUE(*s.search_suffix("na")[0] == "banana");
    ASSERT_TRUE(*s.search_suffix("a")[0] == "banana");
    ASSERT_TRUE(*s.search_suffix("")[0] == "banana");
...
TEST(suffix_trie_tests, sanity_test_2)
{
    ...
    ASSERT_TRUE(*r[0] == "banana" || *r[1] == "banana");
...
TEST(suffix_trie_tests, sanity_test_3)
{
    ...
    s.insert_suffix("banana", "banana");
    s.insert_suffix("ana", "ana");
    s.insert_suffix("not_banana", "not_banana");
    ...
    ASSERT_TRUE(*r[0] == "banana" || *r[1] == "banana" || *r[2] == "banana");
    ASSERT_TRUE(*r[0] == "not_banana" || *r[1] == "not_banana" || *r[2] == "not_banana");
    ASSERT_TRUE(*r[0] == "ana" || *r[1] == "ana" || *r[2] == "ana");
...
TEST(suffix_trie_tests, sanity_test_4)
{
    ...
    s.insert_suffix("printing", file_path_1);
